...
export default function SourceSyncBar({ onSynced, defaultMinimized = false }) {
  ...
  return (
    <div
      className="card source-sync-bar source-sync-bar--expanded"
      style={{ marginBottom: "var(--s4, 16px)" }}
    >
      <div className="card__head" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <div>
          <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
            <Activity size={14} className="text-cyan animate-pulse" style={{ color: "var(--blue, #38bdf8)" }} />
            <h2 style={{ fontSize: 14, margin: 0, fontWeight: 700, letterSpacing: "-0.01em" }}>
              Source Data Integration
            </h2>
          </div>
          <p style={{ margin: "4px 0 0", fontSize: 12, color: "var(--text-3)" }}>
            Railway source systems connected through adapters and simulators
          </p>
        </div>
