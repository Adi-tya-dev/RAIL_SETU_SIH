    ...
    <div className="page" style={{ paddingBottom: 40 }}>
      ...
      >
        <div style={{ display: "flex", gap: 6 }}>
          ...
          >
            <Database size={15} />
            <span>Database Plans Archive</span>
            <span
              style={{
                fontSize: 11,
                padding: "1px 6px",
        ...
        <div style={{ fontSize: 12, color: "var(--text-3)", paddingRight: 10 }}>
          {activeTab === "HORIZONS" ? "Interactive Controller Operations View" : "Persisted Database Records"}
        </div>
      </div>

      {/* HORIZONS VIEW (30-Day Monthly Blueprint & 7-Day Weekly Operations) */}
      {activeTab === "HORIZONS" && <TwoHorizonPlanner initialTab="WEEKLY" />}
      ...
      {activeTab === "ARCHIVE" && (
        <section className="card">
          <div className="card__head" style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
            <div>
              <h2>Historical Database Plan Records</h2>
              <p>Persisted block plans generated by automated scheduler and saved to permanent storage</p>
            </div>
