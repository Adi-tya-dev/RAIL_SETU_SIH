/**
 * Builder script to generate the complete seedData.provider.js containing:
 * - All 50+ stations across India with real coordinates
 * - All sections, tracks, blocks (including B001-B015, B101-B109, NB101-NB128)
 * - All 15 assets
 * - All 20 maintenance tasks
 * - All 43 trains (10 seed.js + 20 seed-longdistance.js + 1 seed-sanghamitra.js + 12 seed-priority.js)
 * - Complete route stops with sequential scheduled arrivals/departures
 * - Comprehensive block movements
 * - Block plans and schedules
 */

const fs = require("fs");
const path = require("path");

const outputFile = path.join(__dirname, "src", "services", "seedData.provider.js");
...
console.log("Successfully wrote all 43 trains & seed data to", outputFile);
